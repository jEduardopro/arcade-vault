...
// Adding Arkanoid later is one line here; nothing else on /games/[id]/play
// needs to change.
//
...
// Loaded on demand, so the six cartridges that are still a CSS animation never
// download an engine, and opening one game does not pull in the other's.
