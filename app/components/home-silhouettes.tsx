// Decorative pixel silhouettes floating behind the hero, copied rect by rect
// from references/templates/home-about/home.jsx. Pure decoration: the wrapper is
// aria-hidden and .home-silos in globals.css makes it pointer-events: none, so
// none of this reaches the accessibility tree or swallows a click. The colors
// are the reference's literals rather than tokens, and s6/s8 punch holes with
// the --bg value (#0a0a0f) baked in, exactly as the original does.
