import type { HighlightIconKind } from "@/app/lib/about";

// HighlightIcon of references/templates/home-about/about.jsx, rect for rect on a
// 16x16 grid. Everything paints in currentColor so each .highlight accent class
// (.magenta, .cyan, .green) drives the icon and its glow; the browser's three
// address-bar dots keep the reference's fixed #0a0a0f, which is the dark chrome
// punched out of the filled title bar.
export function AboutHighlightIcon({ kind }: { kind: HighlightIconKind }) {
    switch (kind) {
        case "HEART":
            return (
