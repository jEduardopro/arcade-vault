import type { FeatureIconKind } from "@/app/lib/home";

// Pixel icons of the "why Arcade Vault" cards, drawn from rects on a 16x16 grid
// exactly as references/templates/home-about/home.jsx does. Everything paints in
// currentColor so each card's accent class (.feature-card.cyan, .magenta, …)
// drives the icon and its glow; only the rocket's window is a fixed --bg value,
// as in the reference.
export function HomeFeatureIcon({ kind }: { kind: FeatureIconKind }) {
  switch (kind) {
    case "GAMEPAD":
      return (
