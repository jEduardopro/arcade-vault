            ...
            be invisible. Same block as the landing, for the same reason. */}
                ...
                <section className="about-hero">
                    ...
                    <p className="about-mission">
                        ARCADE VAULT nació del amor por los videojuegos
                        clásicos. Nuestra misión es preservar y celebrar los
                        arcades que definieron una generación, haciéndolos
                    ...
                    <div className="contact-grid">
                        <div className="contact-intro">
                            ...
                            <p className="contact-sub">
                                ¿Tienes alguna sugerencia, quieres proponer un
                                juego, o simplemente quieres saludar?
                                Escríbenos.
                            </p>
