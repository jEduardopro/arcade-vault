        ...
        <section className="home-hero">
          ...
          <div className="home-hero-inner">
            ...
            <div className="home-ctas">
              ...
              <Link className="btn xl magenta" href="/login?tab=signup">
                ✦ CREAR CUENTA
              </Link>
            </div>
          </div>
          ...
          <div className="hero-scroll" aria-hidden="true" style={{ bottom: 24 }}>
            <span>DESLIZA</span>
              ...
              <div className="top-list">
                {HOME_TOP.map((row, i) => (
                  ...
                  >
                    ...
                    <span className="tp-s">{formatScore(row.score)}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <Reveal className="home-section">
          ...
          <div className="pricing-grid">
            <div className="price-card">
              ...
              <Link className="btn xl pulse" style={{ width: "100%" }} href="/login?tab=signup">
                EMPEZAR GRATIS →
              </Link>
